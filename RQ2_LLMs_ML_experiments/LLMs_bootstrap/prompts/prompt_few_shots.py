...
In the following, I will introduce some examples related to that instance to help you better understand how to define the categories:
==============================
{retrieved_examples}
...
# - Use of keywords like: test, check, ensure, verify, investigate, inspect,
# - Mentions of testing/security and static code checker tools like: tfsec, checkov, terrascan, etc.
# - If such indicators are absent in comments or surrounding context, include only if the code block or module name is explicitly related to testing (e.g., contains test, compliance, or similar terms).
# Be strict and severe — include findings only if they clearly and explicitly relate to Testing.
#
#
# REMEMBER:
# - Assign **all** applicable categories.
...
# Rule:
# - If comment/context explicitly refers to infra management or subcategories, include.
# - Exclude mentions of networking, security, or monitoring unless **explicitly** tied to infra (e.g., “Kubernetes load balancing” → include; “load balancing” alone → exclude).
# - If code block type matches infra resources (e.g., azurerm_virtual_machine, aws_lambda_function) or infra-named modules/variables (e.g., module “ecs_container-definition”), include.
#
# CAT2 - IaC Code Debt
...
# - Assign **all** applicable categories.
# - Do **not** apply your own judgment beyond the definitions.
# - Answer only with the category codes (CAT1–CAT9); no extra text.
#
# Here i will introduce some examples that can be related to that instance and so that you can understand better how to applicate that definition:
#
# ==============================
# {retrieved_examples}
#
